...
<p>Utiliser pour cela la fonction st_as_sf avec l'option coords.</p>
...
<p>Calculer la sensité de monuments par hectare pour chaque iris.</p>
...
<ul>
<li> Thimothé Giraud / Kim antunez
</ul>
