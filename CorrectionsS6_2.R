...
data_pol
plot(st_geometry(data_pol[1:20,]))

as.character(data_dep_naiss$code_dept)
as.character(data_pol$code_insee)

setdiff(as.character(data_dep_naiss$code_dept), as.character(data_pol$code_insee))
...
lover
# nouvelle variable longueur de chaque iris 
iris2154$nbmonum = sapply(lover,length)
# carte
