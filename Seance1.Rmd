...
<h1 style="color:#000">Drew Conway’s Data Science Venn Diagram </h1>
...
## <span class="green">Projet, deezer playlists </span>
- Données : [dépot git](https://github.com/comeetie/Deezerplay) 
- Former des trinômes (semaine prochaine)
- Définir un objectif
- Rendu document Rmarkdown + présentation 
- Date à définir durant la semaine banalisée

## Quelques pointeurs
<ul>
<li>Dépot web du cours : 
